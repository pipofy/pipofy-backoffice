...
Reemplazar `PipoFy · TOKENS COMPARTIDOS` en el comentario de la línea 2 por `PIPOFY · TOKENS COMPARTIDOS`.
...
Reemplaza el SVG inline genérico y el texto "PipoFy · Club Ops" por el
